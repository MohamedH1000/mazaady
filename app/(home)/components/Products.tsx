...
const Products = () => {
  return (
    <div className="w-[840px] min-h-screen bg-white rounded-[21px] p-[25px] mb-10 max-md:w-[343px] max-md:rounded-[24px]">
      ...
      <div className="mt-7 p-[4px] flex flex-col items-center justify-center gap-[24px]">
        {products.map((product, index) => (
          <div
            key={index}
            className="w-full flex items-start justify-start p-4  rounded-[10px] gap-[10px]"
          >
            <div className="w-[145px] h-[127px] relative">
              <Image
                src={product.image}
                alt={"image"}
                width={100}
              ...
              <div
                className={`${
                  product.tags[0] === "LIVE AUCTION"
                    ? "bg-[#D20653]"
                    : "bg-[#FF951D]"
                } w-[114px] h-[37px] rounded-tl-[33.8px] rounded-br-[33.8px] absolute 
            ...
            <div className="flex flex-col items-start justify-between relative w-full">
              <p className="text-[18px] leading-[100%] text-[#333333]">
                {product.name}
              </p>
              <p className="text-[18px] leading-[100%] text-[#828282] font-normal mt-6">
                Starting Price{" "}
                <span className="text-[23.66px] font-bold leading-[100%] text-black ">
                  {product.startingPrice}
                </span>
              </p>
              <div className="flex items-center justify-center gap-2 mt-6">
                <p className="text-[18px] font-normal leading-[100%] text-[#828282]">
                  Lot Starts In
                </p>
                <div className="flex items-center justify-center gap-5">
                  <div
                    className="w-[105px] h-[40px] rounded-[24px] bg-[#FFF5E9] gap-2 
                  text-[#FF951D] flex items-center justify-center font-bold text-[14px]"
                  >
                    <span className="text-[20.28px]">
